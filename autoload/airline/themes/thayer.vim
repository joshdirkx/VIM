...
" applied after g:airline#themes#josh#palette.normal, hence why only certain keys are
" declared.
...
let g:airline#themes#josh#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#josh#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#d78700' , s:I1[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#josh#palette.replace = copy(g:airline#themes#josh#palette.insert)
let g:airline#themes#josh#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#josh#palette.replace_modified = g:airline#themes#josh#palette.insert_modified
...
let g:airline#themes#josh#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#josh#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
